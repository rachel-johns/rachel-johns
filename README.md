...
- 📦 **Packages & Libraries**
  - **Python**: Pandas, NumPy, TensorFlow, Scikit-learn, PyTorch, PyVCF, HTSeq, CNVkit, Biopython, TorchXRayVision, MedPy, PySAM, Scikit-bio, HTSeq, DeepTools, Seaborn, Matplotlib
  - **R**: ggplot2, dplyr, tidyr, shiny, caret, lubridate, Seurat, GenomicRanges, limma, edgeR, EpiEstim, EpiNow2, DESeq2, Bioconductor, quantmod, TTR, xts, zoo
...
![Top Languages](https://github-readme-stats-one-bice.vercel.app/api/top-langs/?username=rachel-johns&layout=compact&theme=dark)
![Rachel's GitHub Stats](https://github-readme-stats-one-bice.vercel.app/api?username=rachel-johns&show_icons=true&theme=dark)
